...
function Home() {
  ...
  //!TODO
  let path = "";
  const categoriesImgPaths = [
    "../../images/Motherboards.png",
    "../../images/Equipos-armados.png",
    "../../images/Consolas.png",
    "../../images/Notebooks.png",
    "../../images/Gabinetes.png",
    "../../images/Fuentes-y-UPS.png",
    "../../images/Procesadores.png",
    "../../images/Cooling.png",
    "../../images/Memorias.png",
    "../../images/Almacenamiento.png",
    "../../images/Tarjetas-de-video.png",
    "../../images/Periféricos.png",
    "../../images/Monitores-y-TV.png",
    "../../images/Sillas.png",
    "../../images/Pendrives.png",
    "../../images/Impresoras.png",
  ];
  const found = categories.find((cat) => cat.isOnSale === true);
  if (found) {
    path = categoriesImgPaths.find((img) =>
      found.name.split(" ").join("-").toLowerCase().includes(img.toLowerCase())
    );
  }
  //const discount = categories.discountAmmount
  //switch (discount) {
  // case 10:
